...
@XmlRootElement(name = "DGICFE:EnvioCFE")
public class EnvioCFE {
	
	@XmlAttribute(name = "xmlns:DGICFE")
	protected String xmlns_dgicfe = "http://cfe.dgi.gub.uy";

    @XmlElement(name = "DGICFE:Caratula", required = true)
     ...
     * 
     */
    @XmlRootElement(name = "DGICFE:Caratula")
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = {
        "rutReceptor",
        "rucEmisor",
    ...
    public static class Caratula {
        ...
        @XmlElement(name = "DGICFE:RutReceptor", required = true)
        protected String rutReceptor;
        @XmlElement(name = "DGICFE:RUCEmisor", required = true)
        protected String rucEmisor;
        @XmlElement(name = "DGICFE:Idemisor", required = true)
        protected BigInteger idemisor;
        @XmlElement(name = "DGICFE:CantCFE")
        protected int cantCFE;
        @XmlElement(name = "DGICFE:Fecha", required = true)
        protected XMLGregorianCalendar fecha;
        @XmlElement(name = "DGICFE:X509Certificate", required = true)

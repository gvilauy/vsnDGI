...
public class Emisor {
    ...
    @XmlElement(name = "ns0:RznSoc", required = true)
    protected String rznSoc;
    @XmlElement(name = "ns0:NomComercial")
    protected String nomComercial;
    @XmlElement(name = "ns0:GiroEmis")
    protected String giroEmis;
    @XmlElement(name = "ns0:Telefono")
    protected List<String> telefono;
    @XmlElement(name = "ns0:CorreoEmisor")
    protected String correoEmisor;
    @XmlElement(name = "ns0:EmiSucursal")
    protected String emiSucursal;
    @XmlElement(name = "ns0:CdgDGISucur", required = true)
    protected BigInteger cdgDGISucur;
    @XmlElement(name = "ns0:DomFiscal", required = true)
    protected String domFiscal;
    @XmlElement(name = "ns0:Ciudad", required = true)
    protected String ciudad;
    @XmlElement(name = "ns0:Departamento", required = true)

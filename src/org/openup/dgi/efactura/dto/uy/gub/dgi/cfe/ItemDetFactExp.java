...
/**
 * <p>Java class for Item_Det_Fact_Exp complex type.
 * 
...
public class ItemDetFactExp {
    ...
    protected List<ItemDetFactExp.CodItem> codItem;
    ...
    protected List<ItemDetFactExp.SubDescuento> subDescuento;
    ...
    protected List<ItemDetFactExp.SubRecargo> subRecargo;
     ...
     * {@link ItemDetFactExp.CodItem }
     * 
     * 
     */
    public List<ItemDetFactExp.CodItem> getCodItem() {
        if (codItem == null) {
            codItem = new ArrayList<ItemDetFactExp.CodItem>();
        }
        return this.codItem;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ItemDetFactExp.SubDescuento }
     * 
     * 
     */
    public List<ItemDetFactExp.SubDescuento> getSubDescuento() {
        if (subDescuento == null) {
            subDescuento = new ArrayList<ItemDetFactExp.SubDescuento>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ItemDetFactExp.SubRecargo }
     * 
     * 
     */
    public List<ItemDetFactExp.SubRecargo> getSubRecargo() {
        if (subRecargo == null) {
            subRecargo = new ArrayList<ItemDetFactExp.SubRecargo>();
        }
